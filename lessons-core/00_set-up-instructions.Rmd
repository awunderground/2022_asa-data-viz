...
We are looking forward to next week's *Data Visualization with R* training. All materials for the training will be easily accessible online. The training should be useful and navigable to newer and experienced users of R. 
...
RStudio 1.4.0 or greater is best. To check your version, open RStudio, click "Help", and click "About RStudio".
...
To update or install `library(tidyverse)` and run `install.packages("tidyverse")` in the RStudio console. *The installation may return prompts in the Console that require responses.*
